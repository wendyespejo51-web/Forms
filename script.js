// ===== 1. LISTA DE LOS 1033 SED VÁLIDOS =====
const listaSED = [
    "00021S",
    "00023S",
    "00028S",
...
function mostrarMensaje(texto, tipo = "info") {
  ...
  msgDiv.innerHTML = texto + ' <button id="cerrarMsg" style="margin-left:10px;">✖</button>';
  ...
  document.getElementById("cerrarMsg").onclick = () => {
...
document.getElementById("enviarBtn").addEventListener("click", async function (e) {
  ...
  btn.disabled = true; // bloquear el botón mientras se procesa
  ...
  for (const archivo of archivos) {
    ...
    datos.imagenes.push({ nombre: archivo.name, contenidoBase64: base64String });
  }
